...
void starplan::init()
{
    ...
    graphene_assert(ast_id == coreAsset && amount == initPool, deposit_check_msg.c_str());
...
{
    inline_transfer(_self, self, coreAsset, z2, LOG_SELF_INVITE_REWARD, strlen(LOG_SELF_INVITE_REWARD));
