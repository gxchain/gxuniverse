...
const char* MSG_INVALID_SELF_ACTIVE_AMOUNT = "Error: 113 GXC required for self active";
const char* MSG_INVALID_INIT_REQUIRED = "Error: 2000000 GXC required for init pool";
const char* MSG_INVALID_VOTE_REQUIRED = "Error: Minimum 0.1 GXC required for vote";
const char* MSG_INVALID_BIG_REQUIRED = "Error: 3 GXC required for init pool";
const char* MSG_INVALID_SUPER_REQUIRED = "Error: 20000 GXC required for init pool";
const char* MSG_SELF_ACTIVE_AUTH_ERR = "Error: Only big planet or super planet can active themselves";
const char* MSG_INVALID_REWARD_ACCOUNT  = "Error: Invalid reward account";
const char* MSG_INVALID_REWARD_AMOUNT = "Error: Invalid reward amount";
