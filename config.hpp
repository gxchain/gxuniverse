...
const uint64_t      roundAmount          = 2000 * precision;         //每一小轮的底池资产数（2000GXC）
...
const uint64_t      initPool             = 2000000 * precision;      //初始化充值200万GXC
...
const uint64_t      roundAmount          = 20 * precision;           //每一小轮的底池资产数（2000GXC）
...
const uint64_t      initPool             = 200 * precision;          //初始化充值200万GXC
...
const uint64_t      MAX_ROUND_REWARD    = roundAmount + roundSize * z1;
