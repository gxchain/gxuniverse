...
{
public:
    starplan(uint64_t id) : contract(id),
...
private:
    ...
    typedef multi_index<N(tbvote), tbvote,
                ...
                indexed_by<N(byround), const_mem_fun<tbvote, uint64_t, &tbvote::by_round>>
            > tbvote_index;
    ...
    typedef multi_index<N(tbstaking), tbstaking,
                indexed_by<N(byaccid), const_mem_fun<tbstaking, uint64_t, &tbstaking::by_acc_id>>
            > tbstaking_index;
    ...
    typedef multi_index<N(tbsmallplan), tbsmallplan,
                ...
                indexed_by<N(byround), const_mem_fun<tbsmallplan, uint64_t, &tbsmallplan::by_create_round>>
            > tbsmallplan_index;
    ...
    typedef multi_index<N(tbbigplanet), tbbigplanet,
                ...
                indexed_by<N(byround), const_mem_fun<tbbigplanet, uint64_t, &tbbigplanet::by_create_round>>
            > tbbigplanet_index;
    ...
    typedef multi_index<N(tbactiveplan), tbactiveplan,
                ...
                indexed_by<N(bytrave), const_mem_fun<tbactiveplan, uint64_t, &tbactiveplan::by_trave>>
            > tbactiveplan_index;
    ...
    typedef multi_index<N(tbsuperstar), tbsuperstar,
                ...
                indexed_by<N(byvote), const_mem_fun<tbsuperstar, uint64_t, &tbsuperstar::by_vote_num>>
            > tbsuperstar_index;
    ...
    typedef multi_index<N(tbinvite), tbinvite,
                ...
                indexed_by<N(byround), const_mem_fun<tbinvite, uint64_t, &tbinvite::by_round>>
            > tbinvite_index;
